...
foreach ($itemsCarrito as $itemCarrito) {
	...
	$httpRequest = file_get_contents('http://localhost/TiendaOnline/productos/api-productos.php?get-item=' . $itemCarrito['codpro']);
...
if (isset($_GET['codpro'])) {
		$res=$carrito->remove($_GET['codpro']);
