         ...
         <div class="content col-md-4 ">
            ...
            <div id="Info"></div>
                ...
                <div class="form-group">
                    ...
                    <input class="form-control placeholder-no-fix input-circle2" type="number"  required placeholder="teléfono" name="telefono" /> 
                </div>
                <div class="form-group">
                    <!--ie8, ie9 does not support html5 placeholder, so we just show field title for that-->
                    <label class="control-label visible-ie8 visible-ie9">N° De Identificación</label>
                    <input class="form-control placeholder-no-fix input-circle2" type="number"  required placeholder="Numero de Identificación" name="ci" /> 
                </div>
                <div class="form-group">
                <label class="control-label visible-ie8 visible-ie9">Departamento</label>
            
			<select class="form-control placeholder-no-fix input-circle2" type="text"  required placeholder="Departamento" id="lista1" name="lista1">
				<option value="0" default selected>Selecciona una opción...</option>
				...
				<option value="88">SAN ANDRÉS PYSC</option>
